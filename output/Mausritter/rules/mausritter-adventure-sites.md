# Mausritter — Adventure Site Toolbox
...
> Related: `mausritter-hexcrawl.md`, `mausritter-gm-guide.md`, `mausritter-creatures.md`, `mausritter-tables.md`.

## Index

1. [Creating an adventure site](#creating-an-adventure-site)
2. [Adventure site theme](#adventure-site-theme)
3. [Randomly stocking rooms](#randomly-stocking-rooms)
4. [Treasure](#treasure)
5. [Magic swords](#magic-swords)
