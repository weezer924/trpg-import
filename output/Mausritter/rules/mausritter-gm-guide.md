# Mausritter — Running Mausritter (GM Guide)

> Source: *Mausritter* SRD 2.3.1 (Copyright 2025 Isaac Williams, Losing Games). Text licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). https://mausritter.com
> Related: `mausritter-rules.md`, `mausritter-example-of-play.md` (tone & pacing reference), `mausritter-hexcrawl.md`, `mausritter-adventure-sites.md`, `mausritter-creatures.md`.

## Index

1. [Best practices](#best-practices)
2. [Asking for a Save](#asking-for-a-save)
3. [Luck rolls](#luck-rolls)
4. [Rulings](#rulings)
5. [Exploration and time](#exploration-and-time)
6. [Overland travel](#overland-travel)
