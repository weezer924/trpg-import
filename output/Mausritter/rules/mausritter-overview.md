...
> Source: *Mausritter* SRD 2.3.1 (Copyright 2025 Isaac Williams, Losing Games; SRD last updated 2026/02/21). Text licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). https://mausritter.com
> This work is based on Mausritter, a product of Losing Games and Isaac Williams.
> Related: `mausritter-character-creation.md`, `mausritter-inventory.md`, `mausritter-rules.md`, `mausritter-magic.md`, `mausritter-hirelings.md`, `mausritter-gear.md`, `mausritter-gm-guide.md`, `mausritter-creatures.md`, `mausritter-hexcrawl.md`, `mausritter-adventure-sites.md`, `mausritter-tables.md`.

## Index

1. [Brave mice in a dangerous world](#brave-mice-in-a-dangerous-world)
2. [What is Mausritter?](#what-is-mausritter)
3. [What you need to play](#what-you-need-to-play)
