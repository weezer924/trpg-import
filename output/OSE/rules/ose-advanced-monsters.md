# OSE Advanced Fantasy — Monsters

> Source: Old-School Essentials Advanced Fantasy Referee's Tome v1.2
...
### Monster Rules
1. [Game Statistics](#game-statistics) — stat block definitions (AC, HD, Att, SV, THAC0, MV, ML, AL, XP, NA, TT)
2. [General Notes](#general-notes) — infravision, languages, persons
...
### Encounter Tables
141. [Dungeon Encounters](#dungeon-encounters) — wandering monsters by dungeon level (1–8+)
142. [Wilderness Encounters](#wilderness-encounters) — wandering monsters by terrain (10 terrain types, 10 sub-tables)
...
**Armour Class (AC):** The monster's ability to avoid damage in combat. The optional Ascending AC (AAC) score is listed afterwards in square brackets.

**Hit Dice (HD):** The number of d8s rolled to determine an individual's hit points.
- **Asterisks:** One or more asterisks after the HD number indicate the number of special abilities the monster has, for the purpose of XP calculation (see p.148).
...
**Attacks Usable Per Round (Att):** The attacks that the monster can use each round, with the inflicted damage in parentheses. (Note that monsters' attack and damage rolls are not modified by STR or DEX, unless specified.) Alternative attack routines are noted with "or" or square brackets.
...
**Attack Roll "to Hit AC 0" (THAC0):** The monster's ability to hit foes in combat, determined by its Hit Dice (see Attack Matrix, p.135). The monster's attack bonus (required when using the optional rule for Ascending AC) is listed afterwards in square brackets.

**Movement Rate (MV):** The speed at which the monster can move. Every monster has a base movement rate and an encounter movement rate (noted in parentheses, one third of the base movement rate). If the monster has multiple modes of movement (e.g. walking, flying, climbing), they are listed individually, separated by slashes.

**Morale Rating (ML):** The monster's likelihood to persist in battle. See Morale, p.133.
...
**Treasure Type (TT):** The letter code used to determine the amount and type of treasure possessed by the monster(s) (see Treasure Types, p.230). The letters listed are used as follows:
...
**Infravision:** All non-human monsters have infravision (see Darkness, p.116). Unless specified in a monster's description, this allows monsters to see in the dark up to 60'.

**Languages:** 20% of intelligent monsters speak Common (see Languages, p.19), unless the monster description states otherwise. Many intelligent monster species also have their own tongue.

**Persons:** Some spells or magical effects only affect creatures classified as "persons". This includes all humans and demihumans, as well as human-like monsters of up to 4+1 HD. The following monsters in this book are classified as "persons": acolyte, bandit, berserker, brigand, buccaneer, bugbear, dervish, dwarf, elf, gnoll, gnome, goblin, halfling, hobgoblin, kobold, lizard man, medium, merchant, merman, neanderthal, nixie, noble, nomad, normal human, ogre, orc, pirate, pixie, sprite, trader, troglodyte, veteran.
...
*AC* 2 [17], *HD* 1 (4hp), *Att* 1 × mace (1d6), *THAC0* 19 [0]
*MV* 60' (20'), *SV* D11 W12 P14 B16 S15 (Cleric 1), *ML* 7, *AL* Any, *XP* 10
*NA* 1d8 (1d20), *TT* U
...
*AC* 6 [13], *HD* 4 (18hp), *Att* 2 × claw (1d4) or 1 × thrown rock (1d6), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 75
*NA* 1d6 (2d4), *TT* None
...
*AC* 6 [13], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D13 W14 P13 B16 S15 (Thief 1), *ML* 8, *AL* Neutral or Chaotic, *XP* 10
*NA* 1d8 (3d10), *TT* U (A)
...
*AC* 4 [15], *HD* 6+1** (28hp), *Att* 1 × bite (1d10 + petrification), 1 × gaze (petrification), *THAC0* 13 [+6]
...
*MV* 30' (10') / 180' (60') flying, *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 20
...
*AC* 6 [13], *HD* 2 (9hp), *Att* 1 × bite (1d4 + unconsciousness), *THAC0* 18 [+1]
*MV* 30' (10') / 180' (60') flying, *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 20
*NA* 1d10 (1d10), *TT* None
...
*AC* 6 [13], *HD* 1hp, *Att* 1 × swarm (confusion), *THAC0* 20 [–1]
*MV* 9' (3') / 120' (40') flying, *SV* D14 W15 P16 B17 S18 (NH), *ML* 6, *AL* Neutral, *XP* 5
*NA* 1d100 (1d100), *TT* None
...
*AC* 6 [13], *HD* 4 (18hp), *Att* 2 × claw (1d3), 1 × bite (1d6), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 75
*NA* 1d4 (1d4), *TT* U
...
*AC* 5 [14], *HD* 7 (31hp), *Att* 2 × claw (1d8), 1 × bite (2d6), *THAC0* 13 [+6]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 9, *AL* Neutral, *XP* 450
*NA* 1d2 (1d2), *TT* V
...
*AC* 6 [13], *HD* 5 (22hp), *Att* 2 × claw (1d4), 1 × bite (1d8), *THAC0* 15 [+4]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 175
*NA* 1 (1d4), *TT* U
...
*AC* 6 [13], *HD* 6 (27hp), *Att* 2 × claw (1d6), 1 × bite (1d10), *THAC0* 14 [+5]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Neutral, *XP* 275
*NA* 1 (1d2), *TT* U
...
*AC* 4 [15], *HD* 1+2 (6hp), *Att* 1 × bite (2d4), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 15
*NA* 1d8 (2d6), *TT* None
...
*AC* 4 [15], *HD* 2* (9hp), *Att* 1 × bite (1d6), 1 × oil spray (blistering), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 25
*NA* 1d8 (2d6), *TT* None
...
*AC* 3 [16], *HD* 3+1 (14hp), *Att* 1 × bite (2d6), *THAC0* 16 [+3]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (1), *ML* 9, *AL* Neutral, *XP* 50
*NA* 1d6 (2d4), *TT* U
...
*AC* 7 [12], *HD* 1+1* (5hp), *Att* 1 × weapon (1d8 or by weapon), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 12, *AL* Neutral, *XP* 19
*NA* 1d6 (3d10), *TT* P (B)
...
*AC* 6 [13], *HD* 10* (45hp), *Att* 1 × touch (3d8), *THAC0* 11 [+8]
...
*AC* 5 [14], *HD* 4* (18hp), *Att* 1 × bite (1d6), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (4), *ML* 6, *AL* Lawful, *XP* 125
*NA* 1d6 (1d6), *TT* C
...
*AC* 7 [12], *HD* 3 (13hp), *Att* 1 × tusk (2d4), *THAC0* 17 [+2]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Neutral, *XP* 35
*NA* 1d6 (1d6), *TT* None
...
*AC* 6 [13], 4 [15], or 3 [16], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Chaotic, *XP* 10
*NA* 0 (1d4 × 10), *TT* A
...
*AC* 7 [12] or 5 [14], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 6, *AL* Neutral, *XP* 10
*NA* 0 (see below), *TT* A

- **Ships and crew:** Depends where encountered. Rivers or lakes: 1d8 river boats (1d2 × 10 buccaneers each); coastal waters: 1d6 small galleys (1d3+1 × 10 buccaneers each); any: 1d4 longships (1d3+2 × 10 buccaneers each); ocean: 1d3 small warships (1d5+3 × 10 buccaneers each). (See Water Vessels, p.50 for details on ships.)
...
*AC* 5 [14], *HD* 3+1 (14hp), *Att* 1 × weapon (2d4 or by weapon +1), *THAC0* 16 [+3]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (3), *ML* 9, *AL* Chaotic, *XP* 50
*NA* 2d4 (5d4), *TT* B
...
*AC* 6 [13], *HD* 6* (27hp), *Att* 1 × bite (1d8), *THAC0* 14 [+5]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (3), *ML* 9, *AL* Neutral, *XP* 500
*NA* 1d3 (1d3), *TT* B
...
*AC* 7 [12], *HD* 2 (9hp), *Att* 1 × bite (1), 1 × hoof (1d4), *THAC0* 18 [+1]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 20
*NA* 0 (2d4), *TT* None
...
*AC* 7 [12], *HD* 3+1* (14hp), *Att* 8 × tentacle (paralysis), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Neutral, *XP* 75
*NA* 1d3 (1d3), *TT* B
...
*AC* 6 [13], *HD* 5 (22hp), *Att* 2 × claw (1d4+1), 1 × bite (1d10), *THAC0* 15 [+4]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (3), *ML* 9, *AL* Neutral, *XP* 175
*NA* 1d4 (1d8), *TT* U
...
*AC* 6 [13], *HD* 3+2 (15hp), *Att* 2 × claw (1d3), 1 × bite (1d6), *THAC0* 16 [+3]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 50
*NA* 1d4 (1d4), *TT* U
...
*AC* 4 [15], *HD* 4 (18hp), *Att* 2 × claw (1d4), 1 × bite (1d8), *THAC0* 16 [+3]
*MV* 210' (70'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 75
*NA* 1d2 (1d6), *TT* U
...
*AC* 6 [13], *HD* 8 (36hp), *Att* 2 × claw (1d8), 1 × bite (2d8), *THAC0* 12 [+7]
*MV* 150' (50'), *SV* D10 W11 P12 B13 S14 (4), *ML* 10, *AL* Neutral, *XP* 650
*NA* 1d4 (1d4), *TT* V
...
*AC* 6 [13], *HD* 6 (27hp), *Att* 2 × claw (1d6), 1 × bite (2d6), *THAC0* 14 [+5]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (3), *ML* 9, *AL* Neutral, *XP* 275
*NA* 1 (1d3), *TT* U
...
*AC* 4 [15], *HD* 2 (9hp), *Att* 1 × bite (1d2) or 1 × jump (1d4) or 1 × spit (stench), *THAC0* 18 [+1]
*MV* 60' (20') / 180' (60') flying, *SV* D12 W13 P14 B15 S16 (2), *ML* 5, *AL* Neutral, *XP* 20
*NA* 2d10 (1d10), *TT* None
...
- **Poison immunity:** Immune to yellow mould (p.215) and most poisons, due to their habit of eating fungi.
...
*AC* 5 [14], *HD* 4 (18hp), *Att* 2 × hoof (1d6), 1 × weapon (1d6 or by weapon), *THAC0* 16 [+3]
*MV* 180' (60'), *SV* D10 W11 P12 B13 S14 (4), *ML* 8, *AL* Neutral, *XP* 75
*NA* 0 (2d10), *TT* A
...
*AC* 9 [10], *HD* ½* (2hp), *Att* 1 × bite (poison), *THAC0* 19 [0]
*MV* 60' (20'), *SV* D14 W15 P16 B17 S18 (NH), *ML* 7, *AL* Neutral, *XP* 6
*NA* 2d4 (1d8), *TT* None
...
*AC* 4 [15], *HD* 9** (40hp), *Att* 2 × claw (1d3), goat: 1 × gore (2d4), lion: 1 × bite (2d4), dragon: 1 × bite (3d4) or 1 × breath (3d6), *THAC0* 12 [+7]
*MV* 120' (40') / 180' (60') flying, *SV* D8 W9 P10 B10 S12 (9), *ML* 9, *AL* Chaotic, *XP* 2,300
*NA* 1d2 (1d4), *TT* F
...
*AC* 6 [13], *HD* 5** (22hp), *Att* 1 × beak (1d6 + petrification), *THAC0* 15 [+4]
*MV* 90' (30') / 180' (60') flying, *SV* D10 W11 P12 B13 S14 (5), *ML* 7, *AL* Neutral, *XP* 425
*NA* 1d4 (1d8), *TT* D
...
*AC* 2 [17], *HD* 3 (13hp), *Att* 2 × pincer (2d6), *THAC0* 17 [+2]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 35
*NA* 1d2 (1d6), *TT* None
...
*AC* 1 [18], *HD* 15 (67hp), *Att* 1 × bite (3d8), *THAC0* 9 [+10]
*MV* 90' (30') / 90' (30') swimming, *SV* D8 W9 P10 B10 S12 (8), *ML* 9, *AL* Neutral, *XP* 1,350
*NA* 0 (1d3), *TT* None
...
*AC* 3 [16], *HD* 6 (27hp), *Att* 1 × bite (2d8), *THAC0* 14 [+5]
*MV* 90' (30') / 90' (30') swimming, *SV* D12 W13 P14 B15 S16 (3), *ML* 7, *AL* Neutral, *XP* 275
*NA* 0 (1d4), *TT* None

#### Normal Crocodile

*AC* 5 [14], *HD* 2 (9hp), *Att* 1 × bite (1d8), *THAC0* 18 [+1]
*MV* 90' (30') / 90' (30') swimming, *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 20
*NA* 0 (1d8), *TT* None
...
*AC* 5 [14], *HD* 13* (58hp), *Att* 1 × club (3d10) or 1 × rock (3d6), *THAC0* 10 [+9]
*MV* 90' (30'), *SV* D4 W5 P6 B5 S8 (13), *ML* 9, *AL* Chaotic, *XP* 2,300
*NA* 1 (1d4), *TT* E + 5,000gp
...
*AC* 6 [13] or 4 [15], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 10, *AL* Lawful, *XP* 10
*NA* 0 (1d6+1 × 10), *TT* A
...
*AC* 5 [14], *HD* 4* (18hp), *Att* 1 × bite (1d12), *THAC0* 16 [+3]
*MV* 90' (30'), *SV* D6 W7 P8 B8 S10 (10), *ML* 10, *AL* Chaotic, *XP* 125
*NA* 1d6 (1d6), *TT* E
...
- **Breath weapon:** Can be used up to three times per day. All caught in the area suffer damage equal to the dragon's current hit points (save versus breath for half). Shapes of breath weapon:
  ...
  - b. **Cone:** 2' wide at the mouth, 30' wide at far end.
  - c. **Line:** 5' wide along whole length.
...
- **Subduing:** Will surrender if reduced to 0hp by non-lethal attacks (see Subduing, p.132), admitting that it has been defeated. (Subdual damage does not reduce the damage done by the breath weapon.) A subdued dragon will attempt to escape or attack its captors, if the opportunity presents itself or if given a suicidal command. A subdued dragon may be sold for up to 1,000gp per hp.
...
*AC* 2 [17], *HD* 7** (31hp), *Att* [2 × claw (1d4+1), 1 × bite (2d10)] or breath, *THAC0* 13 [+6]
*MV* 90' (30') / 240' (80') flying, *SV* D8 W9 P10 B10 S12 (7), *ML* 8, *AL* Chaotic, *XP* 1,250
*NA* 1d4 (1d4), *TT* H
...
*AC* 0 [19], *HD* 9** (40hp), *Att* [2 × claw (1d6+1), 1 × bite (3d10)] or breath, *THAC0* 12 [+7]
*MV* 90' (30') / 240' (80') flying, *SV* D8 W9 P10 B10 S12 (9), *ML* 9, *AL* Neutral, *XP* 2,300
*NA* 1d4 (1d4), *TT* H
...
*AC* –2 [21], *HD* 11** (49hp), *Att* [2 × claw (2d4), 1 × bite (6d6)] or breath, *THAC0* 11 [+8]
*MV* 90' (30') / 240' (80') flying, *SV* D6 W7 P8 B8 S10 (11), *ML* 10, *AL* Lawful, *XP* 2,700
*NA* 1d4 (1d4), *TT* H
...
*AC* 1 [18], *HD* 8** (36hp), *Att* [2 × claw (1d6), 1 × bite (3d8)] or breath, *THAC0* 12 [+7]
*MV* 90' (30') / 240' (80') flying, *SV* D8 W9 P10 B10 S12 (8), *ML* 9, *AL* Chaotic, *XP* 1,750
*NA* 1d4 (1d4), *TT* H
...
*AC* –1 [20], *HD* 10** (45hp), *Att* [2 × claw (1d8), 1 × bite (4d8)] or breath, *THAC0* 11 [+8]
*MV* 90' (30') / 240' (80') flying, *SV* D6 W7 P8 B8 S10 (10), *ML* 10, *AL* Chaotic, *XP* 2,300
*NA* 1d4 (1d4), *TT* H
...
*AC* 1 [18], *HD* 8** (36hp), *Att* 1 × bite (3d8) or breath, *THAC0* 12 [+7]
*MV* 180' (60') swimming / 180' (60') gliding, *SV* D8 W9 P10 B10 S12 (8), *ML* 9, *AL* Neutral, *XP* 1,750
*NA* 0 (1d4), *TT* H
...
*AC* 3 [16], *HD* 6** (27hp), *Att* [2 × claw (1d4), 1 × bite (2d8)] or breath, *THAC0* 14 [+5]
*MV* 90' (30') / 240' (80') flying, *SV* D10 W11 P12 B13 S14 (6), *ML* 8, *AL* Neutral, *XP* 725
*NA* 1d4 (1d4), *TT* H
...
*AC* –2 [21], *HD* 30* (135hp), *Att* [2 × claw (1d8), 1 × bite (1d6 × 10)] or breath, *THAC0* 5 [+14]
*MV* 30' (10') / 90' (30') swimming, *SV* D4 W5 P6 B5 S8 (15), *ML* 10, *AL* Chaotic, *XP* 9,000
*NA* 0 (1), *TT* H
...
*AC* 3 [16], *HD* 4* (18hp), *Att* 1 × bite (2d6), *THAC0* 16 [+3]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7 (12 in melee), *AL* Neutral, *XP* 125
*NA* 2d4 (4d6), *TT* U (see below)
...
*AC* 5 [14], *HD* 2* (9hp), *Att* 1 × magic (charm), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (4), *ML* 6, *AL* Neutral, *XP* 25
*NA* 0 (1d6), *TT* D
...
*MV* 60' (20'), *SV* D8 W9 P10 B13 S12 (Dwarf 1), *ML* 8 (10 with leader), *AL* Lawful or Neutral, *XP* 10
*NA* 1d6 (5d8), *TT* G

- **Leader:** A leader of level 1d6 + 2 is present for every 20 dwarves. The leader may have magic items: 5% chance per level for each magic item table (except Scrolls and Wands/Staves/Rods—Magic Items, p.232).
...
*AC* 2 [17] / 0 [19] / –2 [21], *HD* 8/12/16* (36/54/72hp), *Att* 1 × blow (1d8/2d8/3d8), *THAC0* 12 [+7] / 10 [+9] / 8 [+11]
*MV* 360' (120') flying, *SV* See main entry (8/12/16), *ML* 10, *AL* Neutral, *XP* 1,200/1,900/2,300
*NA* 1 (1), *TT* None
...
*AC* 2 [17] / 0 [19] / –2 [21], *HD* 8/12/16* (36/54/72hp), *Att* 1 × blow (1d8/2d8/3d8), *THAC0* 12 [+7] / 10 [+9] / 8 [+11]
*MV* 60' (20'), *SV* See main entry (8/12/16), *ML* 10, *AL* Neutral, *XP* 1,200/1,900/2,300
*NA* 1 (1), *TT* None
...
*AC* 2 [17] / 0 [19] / –2 [21], *HD* 8/12/16* (36/54/72hp), *Att* 1 × blow (1d8/2d8/3d8), *THAC0* 12 [+7] / 10 [+9] / 8 [+11]
*MV* 120' (40'), *SV* See main entry (8/12/16), *ML* 10, *AL* Neutral, *XP* 1,200/1,900/2,300
*NA* 1 (1), *TT* None
...
*AC* 2 [17] / 0 [19] / –2 [21], *HD* 8/12/16* (36/54/72hp), *Att* 1 × blow (1d8/2d8/3d8), *THAC0* 12 [+7] / 10 [+9] / 8 [+11]
*MV* 60' (20') / 180' (60') swimming, *SV* See main entry (8/12/16), *ML* 10, *AL* Neutral, *XP* 1,200/1,900/2,300
*NA* 1 (1), *TT* None
...
*AC* 5 [14], *HD* 9 (40hp), *Att* 2 × tusk (2d4) or 1 × trample (4d8), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (5), *ML* 8, *AL* Neutral, *XP* 900
*NA* 0 (1d20), *TT* Tusks
...
*MV* 120' (40'), *SV* D12 W13 P13 B15 S15 (Elf 1), *ML* 8 (10 with leader), *AL* Neutral, *XP* 19
*NA* 1d4 (2d12), *TT* E

- **Spells:** Each individual has one random 1st level arcane spell.
- **Leader:** Groups of 15+ are led by an elf of level 1d6 + 1. The leader may have magical items: 5% chance per level for each magic item table (see Magic Items, p.232).
...
*AC* 5 [14], *HD* 1+1 (5hp), *Att* 1 × bite (1d8), *THAC0* 18 [+1]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 15
*NA* 1d8 (1d12), *TT* None
...
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 20
*NA* 0 (2d4), *TT* None
...
*AC* 4 [15], *HD* 8+3 (39hp), *Att* 1 × bite (2d8), 4 × feeler (1d4), *THAC0* 12 [+7]
*MV* 90' (30'), *SV* D10 W11 P12 B13 S14 (4), *ML* 8, *AL* Neutral, *XP* 650
*NA* 0 (1d2), *TT* None
...
*AC* 6 [13], *HD* 3+3 (16hp), *Att* 1 × bite (1d8), *THAC0* 16 [+3]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 50
*NA* 0 (2d4), *TT* None
...
*AC* 7 [12], *HD* 5+5* (27hp), *Att* 4 × spine (1d4 + poison), *THAC0* 14 [+5]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Neutral, *XP* 400
*NA* 0 (2d4), *TT* None
...
*AC* 0 [19], *HD* 10+2* (47hp), *Att* 1 × bite (2d10), *THAC0* 11 [+8]
*MV* 180' (60'), *SV* D10 W11 P12 B13 S14 (5), *ML* 9, *AL* Neutral, *XP* 1,600
*NA* 0 (1), *TT* None
...
*AC* 5 [14], *HD* 4 (18hp), *Att* 2 × claw (1d3), 1 × bite (1d6), 1 × horn (1d4), *THAC0* 16 [+3]
*MV* 90' (30') / 150' (50') flying, *SV* D8 W9 P10 B10 S12 (8), *ML* 11, *AL* Chaotic, *XP* 75
*NA* 1d6 (2d4), *TT* C
...
*AC* 8 [11], *HD* 4\* (18hp), *Att* 1 × touch (2d4 + paralysis), *THAC0* 16 [+3]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (2), *ML* 12, *AL* Neutral, *XP* 125
*NA* 1 (0), *TT* V
...
*AC* 6 [13], *HD* 2\* (9hp), *Att* 2 × claw (1d3 + paralysis), 1 × bite (1d3 + paralysis), *THAC0* 18 [+1]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Chaotic, *XP* 25
*NA* 1d6 (2d8), *TT* B
...
*AC* 4 [15], *HD* 12+3 (57hp), *Att* 1 × weapon (6d6) or 1 × boulder (3d6), *THAC0* 10 [+9]
*MV* 120' (40'), *SV* D6 W7 P8 B8 S10 (12), *ML* 10, *AL* Neutral, *XP* 1,100
*NA* 1d2 (1d3), *TT* E + 5,000gp
...
*AC* 4 [15], *HD* 11+2 (51hp), *Att* 1 × weapon (5d6) or 1 × boulder (3d6), *THAC0* 10 [+9]
*MV* 120' (40'), *SV* D6 W7 P8 B8 S10 (11), *ML* 9, *AL* Chaotic, *XP* 1,100
*NA* 1d2 (1d3), *TT* E + 5,000gp
...
*AC* 4 [15], *HD* 10+1 (46hp), *Att* 1 × weapon (4d6) or 1 × boulder (3d6), *THAC0* 11 [+8]
*MV* 120' (40'), *SV* D6 W7 P8 B8 S10 (10), *ML* 9, *AL* Chaotic, *XP* 900
*NA* 1d2 (1d4), *TT* E + 5,000gp
...
*AC* 4 [15], *HD* 8 (36hp), *Att* 1 × weapon (2d8), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (8), *ML* 8, *AL* Chaotic, *XP* 650
*NA* 1d4 (2d4), *TT* E + 5,000gp
...
*AC* 4 [15], *HD* 9 (40hp), *Att* 1 × weapon (3d6) or 1 × boulder (3d6), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (9), *ML* 9, *AL* Neutral, *XP* 900
*NA* 1d2 (1d6), *TT* E + 5,000gp
...
*AC* 2 [17], *HD* 15 (67hp), *Att* 1 × weapon (8d6), 1 × lightning bolt, *THAC0* 9 [+10]
*MV* 150' (50'), *SV* D4 W5 P6 B5 S8 (15), *ML* 10, *AL* Lawful, *XP* 1,350
*NA* 1 (1d3), *TT* E + 5,000gp
...
*AC* 5 [14], *HD* 2 (9hp), *Att* 1 × weapon (2d4 or by weapon + 1), *THAC0* 18 [+1]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Chaotic, *XP* 20 (leader: 35)
*NA* 1d6 (3d6), *TT* D
...
*MV* 60' (20'), *SV* D8 W9 P10 B13 S12 (Dwarf 1), *ML* 8 (10 in sight of leader or chieftain), *AL* Lawful or Neutral, *XP* 10 (leader: 20, bodyguard: 35, chieftain: 75)
*NA* 1d8 (5d8), *TT* C
...
*AC* 6 [13], *HD* 1–1 (3hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 60' (20'), *SV* D14 W15 P16 B17 S18 (NH), *ML* 7 (9 with king), *AL* Chaotic, *XP* 5 (bodyguard: 20, king: 35)
*NA* 2d4 (6d10), *TT* R (C)
...
*AC* 6 [13], *HD* 10\*\* (45hp), *Att* 2 × claw (2d6), 1 × bite (2d10), *THAC0* 11 [+8]
*MV* 180' (60'), *SV* D10 W11 P12 B13 S14 (5), *ML* 12, *AL* Neutral, *XP* 2,300
*NA* 1 (1), *TT* None
...
*AC* 2 [17], *HD* 8 (36hp), *Att* 2 or 4 × weapon (1d6 or by weapon), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (4), *ML* 12, *AL* Neutral, *XP* 650
*NA* 1 (1), *TT* None
...
*AC* 0 [19], *HD* 20\*\* (90hp), *Att* 1 × fist (3d10 + 1d10 heat), *THAC0* 6 [+13]
*MV* 240' (80'), *SV* D6 W7 P8 B8 S10 (10), *ML* 12, *AL* Neutral, *XP* 4,300
*NA* 1 (1), *TT* None
...
*AC* 7 [12], *HD* 2+2 (11hp), *Att* 1 × fist (1d8), *THAC0* 17 [+2]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 12, *AL* Neutral, *XP* 25
*NA* 1 (1), *TT* None
...
*AC* 2 [17], *HD* 8\* (36hp), *Att* 1 × gore (2d6) or 1 × breath (petrify), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (8), *ML* 8, *AL* Chaotic, *XP* 1,200
*NA* 1d2 (1d4), *TT* E
...
*AC* No hit roll required, *HD* 2\* (9hp), *Att* 1 × touch (consume flesh), *THAC0* 18 [+1]
*MV* 3' (1'), *SV* D12 W13 P14 B15 S16 (1), *ML* 12, *AL* Neutral, *XP* 25
*NA* 1 (0), *TT* None
...
*AC* 8 [11], *HD* 3\* (13hp), *Att* 1 × touch (2d8), *THAC0* 17 [+2]
...
*AC* 5 [14], *HD* 7 (31hp), *Att* 2 × claw (1d4), 1 × bite (2d8), *THAC0* 13 [+6]
*MV* 120' (40') / 360' (120') flying, *SV* D10 W11 P12 B13 S14 (4), *ML* 8, *AL* Neutral, *XP* 450
*NA* 0 (2d8), *TT* E
...
*AC* 7 [12], *HD* 1–1 (3hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 90' (30'), *SV* D8 W9 P10 B13 S12 (Halfling 1), *ML* 7, *AL* Lawful, *XP* 5 (guard: 20)
*NA* 3d6 (5d8), *TT* V (B)
...
*AC* 7 [12], *HD* 3\* (13hp), *Att* 2 × claw (1d4), 1 × weapon (1d6 or by weapon), 1 × song (charm), *THAC0* 17 [+2]
*MV* 60' (20') / 150' (50') flying, *SV* D12 W13 P14 B15 S16 (3), *ML* 7, *AL* Chaotic, *XP* 50
*NA* 1d6 (2d4), *TT* C
...
*AC* 6 [13], *HD* 3+3 (16hp), *Att* 1 × talons or beak (1d6), *THAC0* 16 [+3]
*MV* 450' (150') flying, *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 50
*NA* 0 (1d3), *TT* None
...
*AC* 8 [11], *HD* ½ (2hp), *Att* 1 × talons or beak (1d2), *THAC0* 19 [0]
*MV* 480' (160') flying, *SV* D14 W15 P16 B17 S18 (NH), *ML* 7, *AL* Neutral, *XP* 5
*NA* 0 (1d6), *TT* None
...
*AC* 4 [15], *HD* 3 to 7\* (13/18/22/27/31hp), *Att* 1 × bite (1d6) or 1 × breath (1d6 per HD), *THAC0* By HD (17 [+2] to 13 [+6])
*MV* 120' (40'), *SV* By HD, *ML* 9, *AL* Chaotic, *XP* 50/125/300/500/850
*NA* 2d4 (2d4), *TT* C
...
*AC* 7 [12], *HD* 4 (18hp), *Att* 1 × butt (1d8), *THAC0* 16 [+3]
*MV* 240' (80'), *SV* D12 W13 P14 B15 S16 (2), *ML* 5, *AL* Neutral, *XP* 75
*NA* 0 (3d10), *TT* None
...
*AC* 7 [12], *HD* 3 (13hp), *Att* 1 × butt (1d6), *THAC0* 17 [+2]
*MV* 240' (80'), *SV* D12 W13 P14 B15 S16 (2), *ML* 5, *AL* Neutral, *XP* 35
*NA* 0 (3d10), *TT* None
...
*AC* 7 [12], *HD* 1 to 2 (4/9hp), *Att* 1 × butt (1d4), *THAC0* 19 [0]/18 [+1]
*MV* 240' (80'), *SV* D12 W13 P14 B15 S16 (1), *ML* 5, *AL* Neutral, *XP* 10/20
*NA* 0 (3d10), *TT* None
...
*AC* 5 [14], *HD* 3+1 (14hp), *Att* 2 × claw (1d6), 1 × bite (1d10), *THAC0* 16 [+3]
*MV* 180' (60') / 360' (120') flying, *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 50
*NA* 0 (2d8), *TT* None
...
*AC* 6 [13], *HD* 1+1 (5hp), *Att* 1 × weapon (1d8 or by weapon), *THAC0* 18 [+1]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8 (10 with king), *AL* Chaotic, *XP* 15 (bodyguard: 75, king: 175)
*NA* 1d6 (4d6), *TT* D
...
*AC* 7 [12], *HD* 3 (13hp), *Att* None, *THAC0* 17 [+2]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (2), *ML* 6, *AL* Neutral, *XP* 35
*NA* 0 (0), *TT* None
...
*AC* 7 [12], *HD* 2 (9hp), *Att* 2 × hoof (1d4), *THAC0* 18 [+1]
*MV* 240' (80'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 20
*NA* 0 (0), *TT* None
...
*AC* 7 [12], *HD* 3 (13hp), *Att* 2 × hoof (1d6), *THAC0* 17 [+2]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Neutral, *XP* 35
*NA* 0 (0), *TT* None
...
*AC* 5 [14], *HD* 5 to 12 (8hp per HD), *Att* 5 to 12 × bite (1d10), *THAC0* By HD (15 [+4] to 10 [+9])
*MV* 120' (40'), *SV* By HD, *ML* 9, *AL* Neutral, *XP* 175/275/450/650/900/900/1,100/1,100
*NA* 1 (1), *TT* B
...
*AC* 7 [12], *HD* 2 to 4 (9/13/18hp), *Att* 1 × swarm (2 or 4hp), *THAC0* 18 [+1]/17 [+2]/16 [+3]
*MV* 30' (10') / 60' (20') flying, *SV* D14 W15 P16 B17 S18 (NH), *ML* 11, *AL* Neutral, *XP* 20/35/75
*NA* 1 (1d3), *TT* None
...
*AC* 3 [16], *HD* 8\* (36hp), *Att* 1 × blow (4d4), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (8), *ML* 12, *AL* Neutral, *XP* 1,200
*NA* 1 (1), *TT* None
...
*AC* 7 [12], *HD* ½\* (2hp), *Att* 1 × sting (1d3 + poison + lodged stinger), *THAC0* 19 [0]
*MV* 150' (50') flying, *SV* D12 W13 P14 B15 S16 (1), *ML* 9, *AL* Neutral, *XP* 6 (guard: 13, queen: 25)
*NA* 1d6 (5d6), *TT* Honey
...
*AC* 7 [12], *HD* ½ (2hp), *Att* 1 × weapon (1d4 or by weapon –1), *THAC0* 19 [0]
*MV* 60' (20'), *SV* D14 W15 P16 B17 S18 (NH), *ML* 6 (8 with chieftain), *AL* Chaotic, *XP* 5 (bodyguard: 15, chieftain: 20)
*NA* 4d4 (6d10), *TT* P (J)
...
*AC* 7 [12], *HD* 6 (27hp), *Att* 1 × bite (1d6 + blood drain), *THAC0* 14 [+5]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (3), *ML* 10, *AL* Neutral, *XP* 275
*NA* 0 (1d4), *TT* None
...
*AC* 4 [15], *HD* 3 (13hp), *Att* 2 × blow (1d6), *THAC0* 17 [+2]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (3), *ML* 11, *AL* Lawful, *XP* 35
*NA* 1d6 (1d6), *TT* None
...
*AC* 2 [17], *HD* 4 (18hp), *Att* 2 × blow (1d8), *THAC0* 16 [+3]
*MV* 30' (10'), *SV* D10 W11 P12 B13 S14 (4), *ML* 11, *AL* Neutral, *XP* 75
*NA* 1d4 (1d4), *TT* None
...
*AC* 4 [15], *HD* 5\*\* (22hp), *Att* 2 × magma jet (2d6), *THAC0* 15 [+4]
*MV* 60' (20'), *SV* D10 W11 P12 B13 S14 (5), *ML* 11, *AL* Chaotic, *XP* 425
*NA* 1d3 (1d3), *TT* None
...
*AC* 5 [14], *HD* 4+2 (20hp), *Att* 1 × bite (1d10), *THAC0* 15 [+4]
*MV* 120' (40') / 210' (70') gliding, *SV* D12 W13 P14 B15 S16 (3), *ML* 7, *AL* Neutral, *XP* 125
*NA* 1d4 (1d8), *TT* U
...
*AC* 5 [14], *HD* 3+1 (14hp), *Att* 1 × bite (1d8), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 50
*NA* 1d6 (1d10), *TT* U
...
*AC* 2 [17], *HD* 5\* (22hp), *Att* 1 × tongue/bite (2d4), 1 × horn (1d6), 1 × tail (knock down), *THAC0* 15 [+4]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 7, *AL* Neutral, *XP* 300
*NA* 1d3 (1d6), *TT* U
...
*AC* 4 [15], *HD* 6 (27hp), *Att* 2 × claw (1d4), 1 × bite (2d6), *THAC0* 14 [+5]
*MV* 90' (30'), *SV* D10 W11 P12 B13 S14 (4), *ML* 6, *AL* Neutral, *XP* 275
*NA* 1d2 (1d4), *TT* V
...
*AC* 5 [14], *HD* 2+1 (10hp), *Att* 1 × weapon (1d6+1 or by weapon + 1), *THAC0* 17 [+2]
*MV* 60' (20') / 120' (40') in water, *SV* D12 W13 P14 B15 S16 (2), *ML* 12, *AL* Neutral, *XP* 25
*NA* 2d4 (6d6), *TT* D
...
*AC* 3 [16] (9 [10] in human form), *HD* 9\* (40hp), *Att* 1 × gore (2d6) or 1 × weapon (1d6 or by weapon) or 1 × magic (charm), *THAC0* 12 [+7]
*MV* 180' (60') / 120' (40') in human form, *SV* D8 W9 P10 B10 S12 (9), *ML* 10, *AL* Chaotic, *XP* 1,600
*NA* 1d3 (1d4), *TT* C
...
*AC* 2 [17] (8 [11] in human form), *HD* 6\* (27hp), *Att* 2 × claw (2d4), 1 × bite (2d8), *THAC0* 14 [+5]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (6), *ML* 10, *AL* Neutral, *XP* 500
*NA* 1d4 (1d4), *TT* C
...
*AC* 4 [15] (9 [10] in human form), *HD* 4+1\* (19hp), *Att* 1 × tusk/bite (2d6), *THAC0* 15 [+4]
*MV* 150' (50'), *SV* D10 W11 P12 B13 S14 (4), *ML* 9, *AL* Neutral, *XP* 200
*NA* 1d4 (2d4), *TT* C
...
*AC* 7 [12] (9 [10] in human form), *HD* 3\* (13hp), *Att* 1 × bite (1d4) or 1 × weapon (1d6 or by weapon), *THAC0* 17 [+2]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Chaotic, *XP* 50
*NA* 1d8 (2d8), *TT* C
...
*AC* 3 [16] (9 [10] in human form), *HD* 5\* (22hp), *Att* 2 × claw (1d6), 1 × bite (2d6), *THAC0* 15 [+4]
*MV* 150' (50'), *SV* D10 W11 P12 B13 S14 (5), *ML* 9, *AL* Neutral, *XP* 300
*NA* 1d4 (1d4), *TT* C
...
*AC* 5 [14] (9 [10] in human form), *HD* 4\* (18hp), *Att* 1 × bite (2d4), *THAC0* 16 [+3]
*MV* 180' (60'), *SV* D10 W11 P12 B13 S14 (4), *ML* 8, *AL* Chaotic, *XP* 125 (leader: 300)
*NA* 1d6 (2d6), *TT* C
...
*AC* 4 [15], *HD* 6+1 (28hp), *Att* [2 × claw (1d4), 1 × bite (2d4)] or 6 × tail spike (1d6), *THAC0* 13 [+6]
*MV* 120' (40') / 180' (60') flying, *SV* D10 W11 P12 B13 S14 (6), *ML* 9, *AL* Chaotic, *XP* 350
*NA* 1d2 (1d4), *TT* D
...
*AC* 3 [16], *HD* 15 (67hp), *Att* 2 × tusk (2d6) or 1 × trample (4d8), *THAC0* 9 [+10]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (8), *ML* 8, *AL* Neutral, *XP* 1,350
*NA* 0 (2d8), *TT* Tusks
...
*AC* 9 [10], *HD* 1\*\* (4hp), *Att* 1 × dagger (1d4) or 1 × spell, *THAC0* 19 [0]
*MV* 120' (40'), *SV* D13 W14 P13 B16 S15 (Magic-user 1), *ML* 7, *AL* Any, *XP* 16
*NA* 1d4 (1d12), *TT* V
...
*AC* 8 [11], *HD* 4\*\* (18hp), *Att* 1 × snakebites (1d6 + poison), *THAC0* 16 [+3]
*MV* 90' (30'), *SV* D10 W11 P12 B13 S14 (4), *ML* 8, *AL* Chaotic, *XP* 175
*NA* 1d3 (1d4), *TT* F
...
*AC* 5 [14], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (1), *ML* Varies, *AL* Neutral, *XP* 10
*NA* 0 (1d20), *TT* A
...
*AC* 6 [13], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 10 (leader: 20/75)
*NA* 0 (1d20), *TT* A
...
*AC* 6 [13], *HD* 6 (27hp), *Att* [1 × gore (1d6), 1 × bite (1d6)] or 1 × weapon (1d6 + 2 or by weapon + 2), *THAC0* 14 [+5]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (6), *ML* 12, *AL* Chaotic, *XP* 275
*NA* 1d6 (1d8), *TT* C
...
*AC* 7 [12], *HD* 2 (9hp), *Att* 1 × kick (1d4) or 1 × bite (1d3), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D14 W15 P16 B17 S18 (NH), *ML* 8, *AL* Neutral, *XP* 20
*NA* 1d8 (2d6), *TT* None
...
*AC* 3 [16], *HD* 5+1\* (23hp), *Att* 1 × touch (1d12 + disease), *THAC0* 14 [+5]
*MV* 60' (20'), *SV* D10 W11 P12 B13 S14 (5), *ML* 12, *AL* Chaotic, *XP* 400
*NA* 1d4 (1d12), *TT* D
...
*AC* 8 [11], *HD* 2 (9hp), *Att* 1 × weapon (2d4 or by weapon + 1), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Lawful, *XP* 20
*NA* 1d10 (1d4 × 10), *TT* C
...
*AC* 7 [12], *HD* 1 (4hp), *Att* 1 × weapon (1d4) or 1 × group spell (charm), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P13 B15 S15 (Elf 1), *ML* 6, *AL* Neutral, *XP* 10
*NA* 0 (2d20), *TT* B
...
*AC* 2 [17], *HD* 3 (13hp), *Att* 1 × weapon (1d8 or by weapon), *THAC0* 17 [+2]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Any, *XP* 35
*NA* 2d6 (2d6), *TT* V × 3
...
*AC* 7 [12] to 4, *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Any, *XP* 10
*NA* 0 (1d4 × 10), *TT* A
...
*AC* 9 [10], *HD* ½ (2hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 20 [–1]
*MV* 120' (40'), *SV* D14 W15 P16 B17 S18 (NH), *ML* 6, *AL* Any, usually Lawful, *XP* 5
*NA* 1d4 (1d20), *TT* U
...
*AC* 8 [11], *HD* 5\* (22hp), *Att* 1 × touch (2d6), *THAC0* 15 [+4]
*MV* 30' (10'), *SV* D12 W13 P14 B15 S16 (3), *ML* 12, *AL* Neutral, *XP* 300
*NA* 1 (0), *TT* None
...
*AC* 7 [12], *HD* 8 (36hp), *Att* 8 × tentacle (1d3 + constriction), 1 × bite (1d6), *THAC0* 12 [+7]
*MV* 90' (30'), *SV* D10 W11 P12 B13 S14 (4), *ML* 7, *AL* Neutral, *XP* 650
*NA* 0 (1d2), *TT* None
...
*AC* 5 [14], *HD* 4+1 (19hp), *Att* 1 × club (1d10), *THAC0* 15 [+4]
*MV* 90' (30'), *SV* D10 W11 P12 B13 S14 (4), *ML* 10, *AL* Chaotic, *XP* 125
*NA* 1d6 (2d6), *TT* C + 1,000gp
...
*AC* 6 [13], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 6 (8 with leader), *AL* Chaotic, *XP* 10 (leader: 10, chieftain: 75)
*NA* 2d4 (1d6 × 10), *TT* D
...
*AC* 5 [14], *HD* 5 (22hp), *Att* 2 × claw (1d8), 1 × bite (1d8), *THAC0* 15 [+4]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 9, *AL* Neutral, *XP* 175
*NA* 1d4 (1d4), *TT* C
...
*AC* 6 [13], *HD* 2+2 (11hp), *Att* 2 × hoof (1d6), *THAC0* 17 [+2]
*MV* 240' (80') / 480' (160') flying, *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Lawful, *XP* 25
*NA* 0 (1d12), *TT* None
...
*AC* 7 [12] or 5 [14], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Chaotic, *XP* 10
*NA* 0 (see below), *TT* A
...
*AC* 3 [16], *HD* 1\* (4hp), *Att* 1 × dagger (1d4), *THAC0* 19 [0]
*MV* 90' (30') / 180' (60') flying, *SV* D12 W13 P13 B15 S15 (Elf 1), *ML* 7, *AL* Neutral, *XP* 13
*NA* 2d4 (1d4 × 10), *TT* R + S
...
*AC* 6 [13], *HD* 5 (22hp), *Att* 1 × bite (1d12), *THAC0* 15 [+4]
*MV* 240' (80') flying, *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Neutral, *XP* 175
*NA* 0 (1d4), *TT* V
...
*AC* 7 [12], *HD* 1 (4hp), *Att* 1 × bite (1d3), *THAC0* 19 [0]
*MV* 180' (60') flying, *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 10
*NA* 0 (2d4), *TT* None
...
*AC* 6 [13], *HD* 15\* (67hp), *Att* 1 × bite (2d8), 1 × sting (1d8 + poison), *THAC0* 9 [+10]
*MV* 60' (20'), *SV* D8 W9 P10 B10 S12 (8), *ML* 10, *AL* Neutral, *XP* 2,300
*NA* 1d2 (1d4), *TT* D
...
*AC* 7 [12], *HD* ½ (2hp), *Att* 1 × bite (1d3 + disease), *THAC0* 19 [0]
*MV* 120' (40') / 60' (20') swimming, *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 5
*NA* 3d6 (3d10), *TT* C
...
*AC* 9 [10], *HD* 1hp, *Att* 1 × bite per pack (1d6 + disease), *THAC0* 19 [0]
*MV* 60' (20') / 30' (10') swimming, *SV* D14 W15 P16 B17 S18 (NH), *ML* 5, *AL* Neutral, *XP* 5
*NA* 5d10 (2d10), *TT* L
...
*AC* 5 [14], *HD* 4+2 (20hp), *Att* 1 × sucker (grab), 1 × bite (2d8), *THAC0* 15 [+4]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Neutral, *XP* 125
*NA* 1d4 (1d6), *TT* U
...
*AC* 5 [14], *HD* 6 (27hp), *Att* 1 × horn (2d4) or 1 × trample (2d8), *THAC0* 14 [+5]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 6, *AL* Neutral, *XP* 275
*NA* 0 (1d12), *TT* None
...
*AC* 4 [15], *HD* 8 (36hp), *Att* 1 × horn (2d6) or 1 × trample (2d12), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (4), *ML* 6, *AL* Neutral, *XP* 650
*NA* 0 (1d8), *TT* None
...
*AC* 6 [13], *HD* 2 (9hp), *Att* 1 × bite (1d8), *THAC0* 18 [+1]
*MV* 90' (30') / 180' (60') flying, *SV* D12 W13 P14 B15 S16 (1), *ML* 8, *AL* Neutral, *XP* 20
*NA* 1d6 (2d6), *TT* U
...
*AC* 0 [19], *HD* 36 (162hp), *Att* 2 × claw (3d6), 1 × bite (8d6), *THAC0* 5 [+14]
*MV* 60' (20') / 480' (160') flying, *SV* D2 W3 P4 B3 S6 (18), *ML* 10 (12 in lair), *AL* Lawful, *XP* 6,250
*NA* 0 (1), *TT* I
...
*AC* 2 [17], *HD* 12 (54hp), *Att* 2 × claw (1d8), 1 × bite (2d10), *THAC0* 10 [+9]
*MV* 60' (20') / 480' (160') flying, *SV* D10 W11 P12 B13 S14 (6), *ML* 9 (12 in lair), *AL* Lawful, *XP* 1,100
*NA* 0 (1d8), *TT* I
...
*AC* 4 [15], *HD* 6 (27hp), *Att* 2 × claw (1d4+1), 1 × bite (2d6), *THAC0* 14 [+5]
*MV* 60' (20') / 480' (160') flying, *SV* D12 W13 P14 B15 S16 (3), *ML* 8 (12 in lair), *AL* Lawful, *XP* 275
*NA* 0 (1d12), *TT* I
...
*AC* 6 [13], *HD* 2 (9hp), *Att* 1 × club (1d6), 1 × bite (1d3), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 20
*NA* 2d6 (5d6), *TT* U
...
*AC* 2 [17], *HD* 5 (22hp), *Att* 1 × feeler (rusting), *THAC0* 15 [+4]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 7, *AL* Neutral, *XP* 175
*NA* 1d4 (1d4), *TT* None
...
*AC* 2 [17], *HD* 8\* (36hp), *Att* 2 × claw (1d4), 1 × bite (1d8), 1 × heat aura (1d8), *THAC0* 12 [+7]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (8), *ML* 8, *AL* Neutral, *XP* 1,200
*NA* 1d4+1 (2d4), *TT* F
...
*AC* 3 [16], *HD* 12\* (54hp), *Att* 4 × claw (1d6), 1 × bite (2d6), 1 × cold aura (1d8), *THAC0* 10 [+9]
*MV* 120' (40'), *SV* D6 W7 P8 B8 S10 (12), *ML* 9, *AL* Chaotic, *XP* 1,900
*NA* 1d3 (1d3), *TT* E
...
*AC* 2 [17], *HD* 4\* (18hp), *Att* 2 × claw (1d10), 1 × sting (1d4 + poison), *THAC0* 16 [+3]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (2), *ML* 11, *AL* Chaotic, *XP* 125
*NA* 1d6 (1d6), *TT* V
...
*AC* 7 [12], *HD* 2+2\* (11hp), *Att* 1 × touch (1d4 + strength drain), *THAC0* 17 [+2]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (2), *ML* 12, *AL* Chaotic, *XP* 35
*NA* 1d8 (1d12), *TT* F
...
*AC* 4 [15], *HD* 2 (9hp), *Att* 1 × bite (2d4) or 1 × ram (stun), *THAC0* 18 [+1]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 20
*NA* 0 (3d6), *TT* None
...
*AC* 4 [15], *HD* 8 (36hp), *Att* 1 × bite (2d10), *THAC0* 12 [+7]
*MV* 180' (60'), *SV* D10 W11 P12 B13 S14 (4), *ML* 7, *AL* Neutral, *XP* 650
*NA* 0 (1d4), *TT* None
...
*AC* 4 [15], *HD* 4 (18hp), *Att* 1 × bite (2d6), *THAC0* 16 [+3]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 75
*NA* 0 (2d6), *TT* None
...
*AC* 4 [15], *HD* 1 (4hp), *Att* 2 × bite (1d6), *THAC0* 19 [0]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (1), *ML* 10, *AL* Neutral, *XP* 10
*NA* 1d4 (1d8), *TT* None
...
*AC* 7 [12], *HD* 3 (13hp), *Att* None, *THAC0* 17 [+2]
*MV* 9' (3'), *SV* D12 W13 P14 B15 S16 (1), *ML* 12, *AL* Neutral, *XP* 35
*NA* 1d8 (0), *TT* None
...
*AC* 7 [12], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (1), *ML* 12, *AL* Chaotic, *XP* 10
*NA* 3d4 (3d10), *TT* None
...
*AC* 5 [14], *HD* 4\* (18hp), *Att* 2 × bite (1d4 + poison), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 125
*NA* 1d4 (1d4), *TT* U
...
*AC* 6 [13], *HD* 2\* (9hp), *Att* 1 × bite (1d4 + poison), *THAC0* 18 [+1]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 25
*NA* 1d8 (1d8), *TT* None
...
*AC* 6 [13], *HD* 5\* (22hp), *Att* 1 × bite (1d4 + constriction), *THAC0* 15 [+4]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Neutral, *XP* 300
*NA* 1d3 (1d3), *TT* U
...
*AC* 6 [13], *HD* 3\* (13hp), *Att* 1 × bite (1hp + poison), *THAC0* 17 [+2]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (2), *ML* 7, *AL* Neutral, *XP* 50
*NA* 1d8 (1d8), *TT* None
...
*AC* 7 [12], *HD* 1\* (4hp), *Att* 1 × spit (blindness) or 1 × bite (1d3 + poison), *THAC0* 19 [0]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 13
*NA* 1d6 (1d6), *TT* None
...
*AC* 2 [17], *HD* 6\*\* (27hp), *Att* 1 × touch (1d8 + energy drain), *THAC0* 14 [+5]
*MV* 150' (50') / 300' (100') flying, *SV* D10 W11 P12 B13 S14 (6), *ML* 11, *AL* Chaotic, *XP* 725
*NA* 1d4 (1d8), *TT* E
...
*AC* 6 [13], *HD* 3\* (13hp), *Att* 1 × bite (2d6 + poison), *THAC0* 17 [+2]
*MV* 60' (20') / 120' (40') in webs, *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 50
*NA* 1d3 (1d3), *TT* U
...
*AC* 7 [12], *HD* 2\* (9hp), *Att* 1 × bite (1d8 + poison), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Neutral, *XP* 25
*NA* 1d4 (1d4), *TT* U
...
*AC* 5 [14], *HD* 4\* (18hp), *Att* 1 × bite (1d8 + poison), *THAC0* 16 [+3]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 125
*NA* 1d3 (1d3), *TT* U
...
*AC* 5 [14], *HD* ½\* (2hp), *Att* 1 × spell (curse), *THAC0* 19 [0]
*MV* 60' (20') / 180' (60') flying, *SV* D12 W13 P13 B15 S15 (Elf 1), *ML* 7, *AL* Neutral, *XP* 6
*NA* 3d6 (5d8), *TT* S
...
*AC* 7 [12], *HD* 6 (27hp), *Att* 8 × small tentacle (1d4 + constriction), 2 × large tentacle (1d4 + constriction or 1d10 hull damage), 1 × beak (1d10 or 2 hull damage), *THAC0* 14 [+5]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 7, *AL* Neutral, *XP* 275
*NA* 0 (1d4), *TT* V
...
*AC* 3 [16], *HD* 11 (49hp), *Att* 1 × tail (2d8) or 1 × trample (2d8), *THAC0* 11 [+8]
*MV* 60' (20'), *SV* D10 W11 P12 B13 S14 (6), *ML* 7, *AL* Neutral, *XP* 1,100
*NA* 0 (1d4), *TT* None
...
*AC* 7 [12], *HD* 1\* (4hp), *Att* 1 × beak (1d3 + blood sucking), *THAC0* 19 [0]
*MV* 30' (10') / 180' (60') flying, *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Neutral, *XP* 13
*NA* 1d10 (3d12), *TT* L
...
*AC* 6 [13], *HD* 3\*\* (13hp), *Att* 2 × claw (1d3 + paralysis) or 1 × weapon (1d6 or by weapon), *THAC0* 17 [+2]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (3), *ML* 10, *AL* Chaotic, *XP* 65
*NA* 1d6 (1d10), *TT* C
...
*AC* 5 [14], *HD* 12 (54hp), *Att* 1 × butt (2d6) or 1 × trample (3d8), *THAC0* 10 [+9]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (6), *ML* 7, *AL* Neutral, *XP* 1,100
*NA* 0 (1d6), *TT* None
...
*AC* 7 [12], *HD* 2+2 (11hp), *Att* 1 × bite (1d4+1), *THAC0* 17 [+2]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (1), *ML* 6, *AL* Neutral, *XP* 25
*NA* 1d4 (1d4), *TT* None
...
*AC* 6 [13], *HD* 1 (4hp), *Att* 1 × weapon (1d6 or by weapon), *THAC0* 19 [0]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (1), *ML* 7, *AL* Any, *XP* 10
*NA* 1d8 (3d6), *TT* U + V
...
*AC* 2 [17], *HD* 8 (36hp), *Att* 2 × fist (2d6), *THAC0* 12 [+7]
*MV* 60' (20'), *SV* D8 W9 P10 B10 S12 (8), *ML* 9, *AL* Lawful, *XP* 650
*NA* 0 (1d8), *TT* C
...
*AC* 2 [17], *HD* 11 (49hp), *Att* 1 × gore (3d6) or 1 × trample (3d6), *THAC0* 11 [+8]
*MV* 90' (30'), *SV* D10 W11 P12 B13 S14 (6), *ML* 8, *AL* Neutral, *XP* 1,100
*NA* 0 (1d4), *TT* None
...
*AC* 5 [14], *HD* 2\* (9hp), *Att* 2 × claw (1d4), 1 × bite (1d4), *THAC0* 18 [+1]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 9, *AL* Chaotic, *XP* 25
*NA* 1d8 (5d8), *TT* A
...
*AC* 4 [15], *HD* 6+3\* (30hp), *Att* 2 × talon (1d6), 1 × bite (1d10), *THAC0* 13 [+6]
*MV* 120' (40'), *SV* D10 W11 P12 B13 S14 (6), *ML* 10 (8 fear of fire), *AL* Chaotic, *XP* 650
*NA* 1d8 (1d8), *TT* D
...
*AC* 3 [16], *HD* 20 (90hp), *Att* 1 × bite (6d6), *THAC0* 6 [+13]
*MV* 120' (40'), *SV* D6 W7 P8 B8 S10 (10), *ML* 11, *AL* Neutral, *XP* 2,000
*NA* 0 (1), *TT* V × 3
...
*AC* 2 [17], *HD* 4\* (18hp), *Att* 2 × hoof (1d8), 1 × horn (1d8), *THAC0* 16 [+3]
*MV* 240' (80'), *SV* D8 W9 P10 B10 S12 (8), *ML* 7, *AL* Lawful, *XP* 125
*NA* 1d6 (1d8), *TT* None
...
*AC* 2 [17], *HD* 7 to 9\*\* (31/36/40hp), *Att* 1 × touch (1d10 + energy drain) or 1 × gaze (charm), *THAC0* 13 [+6]/12 [+7]/12 [+7]
*MV* 120' (40'), *SV* D8 W9 P10 B10 S12 (7 to 9), *ML* 11, *AL* Chaotic, *XP* 1,250/1,750/2,300
*NA* 1d4 (1d6), *TT* F
...
*AC* 2 [17], *HD* 1 to 3 (4/9/13hp), *Att* 1 × weapon (1d8 or by weapon), *THAC0* 19 [0]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (F1 to F3), *ML* 9, *AL* Any, *XP* 10/20/35
*NA* 2d4 (2d6), *TT* V
...
*AC* 4 [15], *HD* 6\* (27hp), *Att* 2 × tentacle (2d4), *THAC0* 14 [+5]
*MV* 150' (50'), *SV* D10 W11 P12 B13 S14 (6), *ML* 8, *AL* Neutral, *XP* 500
*NA* 1d4 (1d4), *TT* D
...
*AC* 6 [13], *HD* 2+1 (10hp), *Att* 1 × bite (1d4) or 1 × spray (stun), *THAC0* 17 [+2]
*MV* 120' (40'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 25
*NA* 0 (1d3), *TT* None

#### Saltwater Termite

*AC* 5 [14], *HD* 4 (18hp), *Att* 1 × bite (1d6) or 1 × spray (stun), *THAC0* 16 [+3]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (3), *ML* 11, *AL* Neutral, *XP* 75
*NA* 0 (1d6+1), *TT* None

#### Swamp Termite

*AC* 4 [15], *HD* 1+1 (5hp), *Att* 1 × bite (1d3) or 1 × spray (stun), *THAC0* 18 [+1]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (1), *ML* 10, *AL* Neutral, *XP* 15
*NA* 0 (1d4), *TT* None
...
*AC* 7 [12], *HD* 4+4 (22hp), *Att* 1 × bite (2d4 + blood sucking), *THAC0* 15 [+4]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (3), *ML* 8, *AL* Neutral, *XP* 125
*NA* 1d4 (1d6), *TT* V
...
*AC* 6 [13], *HD* 6 (27hp), *Att* 1 × bite (1d20), *THAC0* 14 [+5]
*MV* 240' (80'), *SV* D12 W13 P14 B15 S16 (3), *ML* 10, *AL* Neutral, *XP* 275
*NA* 0 (1d6), *TT* V
...
*AC* 7 [12], *HD* 12 (54hp), *Att* 1 × bite (1d8), 1 × horn (2d6), *THAC0* 10 [+9]
*MV* 180' (60'), *SV* D6 W7 P8 B8 S10 (12), *ML* 8, *AL* Lawful, *XP* 1,100
*NA* 0 (1d4), *TT* Horn
...
*AC* 6 [13], *HD* 36 (162hp), *Att* 1 × bite (3d20) or 1 × ram (6d6 hull damage), *THAC0* 5 [+14]
*MV* 180' (60'), *SV* D4 W5 P6 B5 S8 (15), *ML* 7, *AL* Neutral, *XP* 6,250
*NA* 0 (1d3), *TT* V
...
*AC* 5 [14], *HD* 3\* (13hp), *Att* 1 × touch (energy drain), *THAC0* 17 [+2]
*MV* 90' (30'), *SV* D12 W13 P14 B15 S16 (3), *ML* 12, *AL* Chaotic, *XP* 50
*NA* 1d6 (1d8), *TT* B
...
*AC* 6 [13], *HD* 4+1 (19hp), *Att* 1 × bite (2d4), *THAC0* 15 [+4]
*MV* 150' (50'), *SV* D12 W13 P14 B15 S16 (2), *ML* 8, *AL* Neutral, *XP* 125
*NA* 1d4 (2d4), *TT* None
...
*AC* 7 [12], *HD* 2+2 (11hp), *Att* 1 × bite (1d6), *THAC0* 17 [+2]
*MV* 180' (60'), *SV* D12 W13 P14 B15 S16 (1), *ML* 6 (8 in larger packs), *AL* Neutral, *XP* 25
*NA* 2d6 (3d6), *TT* None
...
*AC* 3 [16], *HD* 4\*\* (18hp), *Att* 1 × touch (1d6 + energy drain), *THAC0* 16 [+3]
*MV* 120' (40') / 240' (80') flying, *SV* D10 W11 P12 B13 S14 (4), *ML* 12, *AL* Chaotic, *XP* 175
*NA* 1d4 (1d6), *TT* E
...
*AC* 3 [16], *HD* 7\* (31hp), *Att* 1 × bite (2d8), 1 × sting (1d6 + poison), *THAC0* 13 [+6]
*MV* 90' (30') / 240' (80') flying, *SV* D10 W11 P12 B13 S14 (4), *ML* 9, *AL* Chaotic, *XP* 850
*NA* 1d2 (1d6), *TT* E
...
*AC* No hit roll required, *HD* 2\* (9hp), *Att* 1 × spores (1d6 + choking), *THAC0* 18 [+1]
...
*AC* 8 [11], *HD* 2 (9hp), *Att* 1 × weapon (1d8 or by weapon), *THAC0* 18 [+1]
*MV* 60' (20'), *SV* D12 W13 P14 B15 S16 (1), *ML* 12, *AL* Chaotic, *XP* 20
*NA* 2d4 (4d6), *TT* None
...
This section provides encounter tables for dungeons and wilderness.

### Dungeon Encounters

Roll 1d20 and look up the result on the column corresponding to the dungeon level being explored. The result indicates the monster encountered, with the number appearing in parentheses.
...
- **NPC adventurers:** Encounters with NPC adventuring parties are listed in the tables as "Basic Adventurers" or "Expert Adventurers". Guidelines for generating NPC adventurers can be found under Adventuring Parties, p.224.
...
1. Look up the d8 result on the column in the table below that corresponds to the terrain being explored. The result indicates which sub-table to consult.
2. Look up the d12 result in the sub-table indicated.
...
- **NPC adventurers:** Encounters with NPC adventuring parties are listed in the tables as "Basic Adventurers", "Expert Adventurers", "High-Level Cleric", "High-Level Fighter", or "High-Level Magic-User". Guidelines for generating NPC adventurers can be found under Adventuring Parties, p.224.
...
#### Sub-Table 1: Dragon, Flyer, Insect
<!-- PDF p.221 -->
...
#### Sub-Table 2: Prehistoric Animal, Undead, Unusual
<!-- PDF p.221 -->
...
- **Magic items:** Per individual: there is a chance of the NPC having a magic item from each suitable magic item sub-table (see Magic Items, p.232). The chance per sub-table is 5% per level of the NPC. Rolled items that cannot be used by the NPC should be ignored (no re-roll).

#### NPC Adventurer Class and Level

| d8 | Class | Basic Level | Expert Level |
|---:|-------|:-----------:|:------------:|
| 1 | Cleric | 1d3 | 1d6+3 |
| 2 | Dwarf | 1d3 | 1d6+6 |
| 3 | Elf | 1d3 | 1d6+2 |
...
The reaction of the ruler to travellers in their domain depends on the class of the ruler and can be determined by rolling 1d6:
